...
[GitHubActions("pull-request", GitHubActionsImage.WindowsLatest,
    ...
    IDeployNuGetTarget
{
    ...
    public IEnumerable<Project> TestProjects => GetTestsProjects();

    IEnumerable<Project> GetTestsProjects()
    {
    ...
    string IPackSettings.PackageProjectUrl => "https://github.com/CreativeCodersTeam/Core.Windows";
